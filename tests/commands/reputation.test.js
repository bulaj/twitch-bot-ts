...
const rep_1 = require("../../src/commands/reputation/rep");
const reputation_manager_1 = require("../../src/database/reputation.manager");
jest.mock("../../src/database/reputation.manager");
const mockChangeReputation = reputation_manager_1.ReputationManager.changeReputation;
