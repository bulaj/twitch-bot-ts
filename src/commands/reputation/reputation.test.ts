import { RepCommand } from "./reputation";
...
describe("RepCommand", () => {
  ...
  it("should add reputation point with !rep+", () => {
    ...
    RepCommand.execute(mockClient, "#test", userstate as any, "!rep+ @user_b", [
      "@user_b",
    ]);
  ...
  it("should not allow user to change their own reputation", () => {
    ...
    RepCommand.execute(mockClient, "#test", userstate as any, "!rep+ @user_a", [
      "@user_a",
    ]);
